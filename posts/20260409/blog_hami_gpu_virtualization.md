...
**参考资料**：
- TAI Admission Webhook 可复现联调步骤（含步骤 1 webhook、本文 5.4 对应的 LWS 全文）：`tai-admission-webhook` 仓库 `tests/tai-admission-webhook-test.md`（本地开发时常为 `tai-admission-webhook/tests/tai-admission-webhook-test.md`）
